...
type VerificationContext = "register" | "login";
...
export function AuthModal({ open, onOpenChange, defaultMode = "login" }: AuthModalProps) {
  ...
  const [verificationContext, setVerificationContext] =
    useState<VerificationContext>("register");

  // Reset state
  const [resetEmail, setResetEmail] = useState("");
  const [resetSent, setResetSent] = useState(false);

  // LOGIN AGORA USA loginStart (etapa 1 do 2FA)
  const loginMutation = trpc.auth.loginStart.useMutation({
    onSuccess: (data) => {
        ...
        {mode === "login" && (
          <>
            <DialogHeader>
              ...
              <DialogDescription>
                Entre com seu email e senha para receber o código de acesso.
              </DialogDescription>
            </DialogHeader>
        ...
        {mode === "verify" && (
          <>
            <DialogHeader>
              ...
              <DialogDescription>
                {verificationContext === "register"
                  ? `Enviamos um código de verificação para ${pendingEmail}. Digite o código abaixo para ativar sua conta.`
                  : `Enviamos um código de acesso para ${pendingEmail}. Digite o código abaixo para entrar com segurança.`}
              </DialogDescription>
            </DialogHeader>
